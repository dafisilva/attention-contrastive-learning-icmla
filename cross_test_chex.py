...
from utilities.chexpert_utils import *
from datasets.dataset_chexpert import *
...
wandb.init(
    ...
    name='Model test: CheXpert fold ' +str(FOLD),
...
evalset=Dataset_Chex(eval_df,root,transf_neg,pathology)
...
acc=torchmetrics.classification.BinaryAccuracy(threshold=0.5).to(device) #Binar
