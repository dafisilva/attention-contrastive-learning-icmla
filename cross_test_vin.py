...
from datasets.dataset_vindrcxr import *

from models.models_brax import *

from utilities.vindr_utils import *
...
wandb.init(
    ...
    name='Model Test: VinDrCXR fold' +str(FOLD),
...
evalset=Dataset_VINDRCXR(eval_df,root,transf,pathology)
